...
TEST(CommandHandlersFTest_SoA, HandleInfo_Valid) {
    std::string const command = "./imtool-soa/imtool-soa ../in/lake-small.ppm info";
...
TEST(CommandHandlersFTest_SoA, HandleInfo_InvalidFile) {
    std::string const command = "./imtool-soa/imtool-soa ../in/nonexistent.ppm info";
    std::string const output = getCommandOutput(command);
...
TEST(CommandHandlersFTest_SoA, HandleCompress_Valid) {
    std::string const command = "./imtool-soa/imtool-soa ../in/lake-small.ppm ../output-soa/test compress";
    std::string const output = getCommandOutput(command);
    ...
    std::ifstream outFile("../output-soa/test.cppm");
    EXPECT_TRUE(outFile.is_open());
    outFile.close();
}

// Test para el comando 'compress' con un archivo inválido
TEST(CommandHandlersFTest_SoA, HandleCompress_InvalidFile) {
    std::string const command = "./imtool-soa/imtool-soa ../in/nonexistent.ppm ../output-soa/test compress";
    std::string const output = getCommandOutput(command);
